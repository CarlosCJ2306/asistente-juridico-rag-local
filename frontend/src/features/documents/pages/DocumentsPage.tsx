...
export function DocumentsPage() {
  ...
  return (
    <ContentLayout title="Biblioteca documental" description="Consulta los metadatos públicos, la procedencia y la disponibilidad de los documentos para recuperación local.">
      ...
      {status === "success" && query.data ? (
        ...
        <AsyncContent
          ...
          presentations={{
            empty: <EmptyState title="La biblioteca está vacía" description="La carga documental se habilitará en el siguiente bloque. Esta vista no crea ni modifica documentos." />,
